  ...
  id: {
    ...
    ventures: {
      ...
      upcoming: {
        ...
        tag: "Dijajaki",
        status: "Masih riset",
        desc: "Teknologi keselamatan publik: deteksi ancaman di infrastruktur penting, dipasang cuma di lokasi yang operatornya sendiri minta, pakai dasar hukum, batas simpan data, dan jejak audit. Bukan pemantauan massal warga.",
  ...
  en: {
    ...
    ventures: {
      ...
      upcoming: {
        ...
        desc: "Public-safety technology: threat detection at critical infrastructure, deployed only where the site operator asks for it, with a legal basis, retention limits, and an audit trail. Not population-scale monitoring.",
