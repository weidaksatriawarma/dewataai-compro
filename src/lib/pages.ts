    ...
    ventures: {
      ...
      register: {
        ...
        vacant: {
          ...
          desc: "Deteksi ancaman buat infrastruktur penting. Masih riset, belum ada produknya.",
          action: "Lihat",
        },
      },
      third: {
        ...
        desc: "Riset teknologi keselamatan publik buat infrastruktur penting di Indonesia. Belum ada produk, belum ada pelanggan.",
    ...
    ventures: {
      ...
      register: {
        ...
        vacant: {
          ...
          name: "Third venture",
          field: "Public safety",
          desc: "Threat detection for critical infrastructure. Still research, no product yet.",
          action: "View",
        },
      },
      third: {
        ...
        desc: "Researching public-safety technology for critical infrastructure in Indonesia. No product and no customer yet.",
